Public Class ERP_Mantenimiento_Category
    Private objDatos As New Generic_SQLServer
    Private dtCategorias As DataTable
    Property Id_Company_FK As Long
    Property Name_Categorias As String
    Property id_Categoria As Long = 0
    Property ledgerAccountNumber As String = ""
    Property ledgerCodeProduct As String = ""
    Property Title As String

    Private Sub Mantenimiento_Generic_Municipality_Load(sender As Object, e As EventArgs) Handles Me.Load
        If id_Categoria <> 0 Then
            txtNameCategory.Text = Name_Categorias
            GroupBox1.Text = Title
            txtledgerCodeProduct.Text = ledgerCodeProduct
            txtledgerAccountNumber.Text = ledgerAccountNumber
        End If
    End Sub

    Private Sub cmdSave_Click(sender As Object, e As EventArgs) Handles cmdSave.Click
        If txtNameCategory.Text = "" Then
            ...
            Exit Sub
        End If
        If id_Categoria > 0 Then ' Es modificacion
            Dim resp As String = objDatos.SetCategoria(Id_Company_FK, id_Categoria, txtNameCategory.Text, txtledgerCodeProduct.Text, txtledgerAccountNumber.Text)
            If resp = "OK" Then
        ...
        Else
            Dim resp As String = objDatos.InsertCategoria(Id_Company_FK, txtNameCategory.Text, txtledgerCodeProduct.Text, txtledgerAccountNumber.Text)
            If resp = "OK" Then
                DialogResult = DialogResult.OK
