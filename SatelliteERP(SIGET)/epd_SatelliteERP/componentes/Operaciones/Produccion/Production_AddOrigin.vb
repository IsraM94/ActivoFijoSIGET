Public Class Production_AddOrigin
    ...
    End Sub
    Private Sub GetData()
        txtNameOrigen.Text = Name_Genetic
    End Sub

    Private Sub cmdSave_Click(sender As Object, e As EventArgs) Handles cmdSave.Click
        If txtNameOrigen.Text <> "" Then

            If Id_Genetic > 0 Then ' Es modificacion
                If objDatos.SetOrigin(Id_Genetic, Data_Id_Company, txtNameOrigen.Text) = "OK" Then
                ...
                End If
            Else
                If objDatos.InsertOrigin(Data_Id_Company, txtNameOrigen.Text) = "OK" Then
                    DialogResult = DialogResult.OK
                    Close()
                Else
