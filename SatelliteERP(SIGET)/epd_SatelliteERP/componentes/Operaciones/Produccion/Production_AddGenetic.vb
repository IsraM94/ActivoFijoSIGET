Public Class Production_AddGenetic
    ...
    End Sub
    Private Sub GetData()
        txtNameGenetic.Text = Name_Genetic
    End Sub

    Private Sub cmdSave_Click(sender As Object, e As EventArgs) Handles cmdSave.Click
        If txtNameGenetic.Text <> "" Then

            If Id_Genetic > 0 Then ' Es modificacion
                If objDatos.SetGenetic(Id_Genetic, Data_Id_Company, txtNameGenetic.Text) = "OK" Then
                ...
                End If
            Else
                If objDatos.InsertGenetic(Data_Id_Company, txtNameGenetic.Text) = "OK" Then
                    DialogResult = DialogResult.OK
                    Close()
                Else
