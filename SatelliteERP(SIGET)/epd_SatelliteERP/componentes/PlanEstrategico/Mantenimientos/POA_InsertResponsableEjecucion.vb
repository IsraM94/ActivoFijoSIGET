Public Class POA_InsertResponsableEjecucion
...
#End Region
    ...
    Private Sub cmdGrabar_Click(sender As Object, e As EventArgs) Handles btnGrabar.Click
        ...
        If _isInsert Then
            Dim dt As String
            dt = objsql.ERP_StrategicPlan_InserResponsibleExecution(txt_POA_AddResponsable.Text, txt_POA_DescripcionResponsable.Text)
        Else
            Dim dt As String
            dt = objsql.ERP_StrategicPlan_UpdateResponsibleExecution(_id_ResponsableEjecucion, txt_POA_AddResponsable.Text, txt_POA_DescripcionResponsable.Text)
        End If
