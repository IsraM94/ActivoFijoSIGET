Public Class ERP_CuentasPorCobrar_ListaLineasCreditos
    ...
    Private Sub cmdSelect_Click(sender As Object, e As EventArgs) Handles cmdSelect.Click
        For i As Integer = 0 To DT_LineasCredito.Rows.Count - 1
            If DT_LineasCredito.Rows(i)("ID_AccountsList") = DGVListaLineaCredito.CurrentRow.Cells(0).Value Then
                RowSeleccion = i
                Exit For
            End If
        Next
    ...
    Private Sub ERP_CuentasPorCobrar_ListaLineasCreditos_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        DGVListaLineaCredito.Columns(0).Width = 90
        DGVListaLineaCredito.Columns(1).Width = 200
        ...
        DGVListaLineaCredito.Columns(3).Width = 140
        DGVListaLineaCredito.Columns(4).Width = 150
        DGVListaLineaCredito.Columns(5).Width = 220
        ...
        DGVListaLineaCredito.AllowUserToResizeColumns = True
