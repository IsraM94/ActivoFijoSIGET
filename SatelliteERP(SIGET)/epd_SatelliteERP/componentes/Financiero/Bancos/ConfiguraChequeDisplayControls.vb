...
Public Class ConfiguraChequeDisplayControls
    Private _IsCreditoFiscal As Boolean
    Private _DS_Config As DataSet
    Private _DS_Schema As DataSet
    Private objFinance As New Financiero_SQLServer
    Private _PictureFactura As New PictureBox
    Private _id_bank As Long
    Private _ID_Type_Billing As Long
    Private ConfigXML As String
    Private ConfigSchema As String

    Sub New(ByVal DS_Config As DataSet, ByVal DS_Schema As DataSet, ByVal id_bank As Integer)
    ...
    Private Sub cmdPreview_Click(sender As Object, e As EventArgs) Handles cmdPreview.Click
        ...
        Dim obj As New Config_Cheque(CB_TipoFactura.Text, _DS_Config, PB_FacturaActual)
        obj.FacEncabezado(1234, "Nombre Cliente o Razon Social", "12343-3", "0000-000000-0-000", Now, "La Direccion", Now,
    ...
    Private Sub cmdGrabar_Click(sender As Object, e As EventArgs) Handles cmdGrabar.Click
        ...
        objFinance.SetConfigCheck(_id_bank, Data_Id_Company, _ID_Type_Billing, CB_TipoFactura.Text, Datos, Schema, data, True)
    End Sub
    Private Sub CrearConfCheque()
        Dim Datos As String = _DS_Config.GetXml()
        Dim Schema As String = _DS_Schema.GetXmlSchema
        Dim ms As New MemoryStream()

        PB_FacturaActual.Image = Image.FromFile("../../Resources/whiteback.png")
        'PB_FacturaActual.Image = Image.FromFile(My.Application.Info.DirectoryPath + "picture.png")

        PB_FacturaActual.Image.Save(ms, PB_FacturaActual.Image.RawFormat)
        Dim data As Byte() = ms.GetBuffer()
        objFinance.CreateConfigCheck(Data_Id_Company, _id_bank, CB_TipoFactura.Text, Datos, Schema, data, True)
    End Sub
End Class
